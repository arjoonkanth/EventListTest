...
class Event_Listing {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_admin, 'cpt_setup_init' );
		$this->loader->add_action( 'add_meta_boxes', $plugin_admin, 'cpt_setup_metabox' );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter( 'archive_template', $plugin_public, 'get_archive_post_type_template' );
		$this->loader->add_filter( 'single_template', $plugin_public, 'get_single_post_type_template' );
